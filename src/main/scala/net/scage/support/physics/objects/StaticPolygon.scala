...
class StaticPolygon(restitution:Boolean, val vertices:List[Vec]) extends Physical {
  def this(vertices:Vec*) {this(property("physics.restitution", false), vertices.toList)}
  def this(vertices:Array[Vec]) {this(property("physics.restitution", false), vertices.toList)}
  def this(vertices:List[Vec]) {this(property("physics.restitution", false), vertices)}
